                                ...
                                {items.map((item) => (
                                    <li key={item.id} className="flex px-4 py-6 sm:px-6">
                                        <div className="flex-shrink-0">
                                            <img src={item.thumbnail} alt={item.title} className="w-20 rounded-md" />
                                        </div>
                                            ...
                                            <div className="flex">
                                                ...
                                                <div className="ml-4 flow-root flex-shrink-0">
                                                    ...
                                                    >
                                                        ...
                                                        <TrashIcon onClick={e => handleRemove(e, item.id)} className="h-5 w-5" aria-hidden="true" />
                                                    </button>
                                                </div>
                                            </div>
                            ...
                            <section aria-labelledby="shipping-heading" className="mt-10">
                                ...
                                <ul role="list">
                                    {addresses.map((address) => (
                                        <li key={address.email} className="flex justify-between gap-x-6 px-2 m-2 py-2 border-solid border-2 border-gray">
                                            <div className="flex gap-x-4">
                                                <input name='address' type='radio' className='h-4 w-4 border-gray-300 text-indigo-600' />
                                                <div className="min-w-0 flex-auto">
                                                    <p className="text-sm font-semibold leading-6 text-gray-900">{address.name}</p>
                                                    <p className="mt-1 truncate text-xs leading-5 text-gray-500">{address.street}</p>
                                                    <p className="text-xs leading-6 text-gray-500">{address.pinCode}</p>
                                                </div>
                                            </div>
                                            <div className="hidden sm:flex sm:flex-col sm:items-end">
                                                <p className="text-sm leading-6 text-gray-500">Phone: {address.phone}</p>
                                                <p className="text-xs leading-6 text-gray-500">{address.city}</p>
                                            </div>
                                        </li>
                                    ))}
                                </ul>
